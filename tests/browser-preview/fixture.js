...
const data = {
  ...
  produtos: [{ id: 'product-test', name: 'Anel de teste', sku: 'TEST-1', material: 'Prata 925', purity: 925, cost_price: 30, sale_price: 100, promotional_price: null, minimum_stock: 1, active: true, imagens_produtos: [{ storage_path: 'product-test/foto.svg', is_cover: true }] }],
