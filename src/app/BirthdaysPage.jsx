...
export function BirthdaysPage() {
  ...
  return <div className="page-content">
    ...
    <section className="panel birthday-policy"><span className="birthday-gift">10%</span><div><strong>Presente de aniversário Finesse</strong><p>A mensagem oferece 10% de desconto na próxima compra. O desconto é aplicado manualmente no pedido; esta tela não altera preços nem cria cupom.</p></div></section>
