...
export function PasswordSetupScreen() {
  ...
  return <main className="auth-layout">
    <section className="auth-brand-panel"><div><div className="logo-lockup"><span className="logo-symbol">F</span><span>finesse</span></div><p className="brand-kicker">silver · controle interno</p></div><div className="brand-message"><p className="eyebrow">Primeiro acesso</p><h1>Seu espaço começa aqui.</h1><p>Defina uma senha pessoal para concluir o convite da sua conta master.</p></div><span className="brand-footer">Acesso restrito aos dois usuários master</span></section>
