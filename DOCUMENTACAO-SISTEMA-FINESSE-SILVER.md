...
- **Estado de implantação (23/09/2026):** a Edge Function `public-catalog` está implantada, seu endpoint público foi carregado pela vitrine de preview e mostrou o catálogo real do Supabase; a configuração de segredo permaneceu somente no runtime Supabase. O Site URL e Redirect URL do painel foram configurados no Auth. Os artefatos ainda precisam ser enviados à branch `main` e verificados no endereço publicado do GitHub Pages.
